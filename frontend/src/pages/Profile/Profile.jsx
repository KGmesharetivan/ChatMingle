  ...
  return (
    <div className="bg-gray-100 min-h-min">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://lh3.googleusercontent.com/ledvgumQmauwI-C2mKr31nAJ4rVLkNz3GAz8fpufS2HdNXVOKVQ1bLOuqYg_kJ8XWiYW9fovz298cBjknYB0sMwpiu6uG8tlpw=w1200-h600-pp-rj-s365)",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="flex justify-end top-4 right-7 relative border-solid font-semibold">
          Edit Profile <DriveFileRenameOutlineIcon />
        </div>
        {/* Profile Picture */}
        <div
      ...
      <div className="max-w-xl mx-auto px-5 mt-4">
        ...
        <p className="mt-4 text-gray-700">
          🌈 Exploring life's wonders | 📸 Amateur Photographer ✨ Embrace the
          journey, and the journey will embrace you. I love chocolate,
          especially choco-pie. Im the most flexible member. I have very pale
          skin, My nickname Dubu. I can touch my nose with my tongue.
        </p>
