...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_u7kj057', 'template_4ptotpq', form.current, 'Nkz7vK-OK1ycQpFui')
      .then((result) => {
        console.log(result.text);
        console.log("message sent!");
        console.log("Wait for a minutes to received the email");
      }, (error) => {
      ...
      <form ref={form} onSubmit={sendEmail} action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label htmlFor="your-name" className="block text-sm font-semibold leading-6 text-gray-900">
              Your Name: 
            </label>
